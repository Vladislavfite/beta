// Full Beta Tower Defense — fixed final version
...
function create(){
  ...
  if (this.textures.exists('mappath')) this.add.image(360,640,'mappath').setDisplaySize(720,1280).setAlpha(0.5);
  ...
  this.add.rectangle(160,1005,153,93,0x0000ff,0.25).setOrigin(0.5);
...
function startNextWave(scene){
  ...
  ui.waveText.setText('Wave:'+wave); ui.goldText.setText('Gold:'+gold);
  canWatchAd=true;
